...
namespace RankOne.Analyzers.Performance
{
    public class JavascriptMinificationAnalyzer : MinificationAnalyzer
    {
        ...
        public JavascriptMinificationAnalyzer(RankOneContext rankOneContext) : this(rankOneContext.MinificationHelper.Value, rankOneContext.CacheHelper.Value, rankOneContext.UrlHelper.Value)
        { }

        public JavascriptMinificationAnalyzer(IMinificationHelper minificationHelper, ICacheHelper cacheHelper, IUrlHelper urlHelper) : base(minificationHelper, cacheHelper, urlHelper)
        { }

        protected override string CacheKeyPrefix => "js_minified_";
