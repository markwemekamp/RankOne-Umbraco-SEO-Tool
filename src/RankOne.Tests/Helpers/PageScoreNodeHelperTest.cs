...
namespace RankOne.Tests.Helpers
{
    ...
    public class PageScoreNodeHelperTest
    {
        ...
        {
            new PageScoreNodeHelper(null, new Mock<INodeReportService>().Object, new PageScoreSerializer(), new AnalyzeService());
        }
        ...
        {
            new PageScoreNodeHelper(new Mock<ITypedPublishedContentQuery>().Object, null, new PageScoreSerializer(), new AnalyzeService());
        }
        ...
        {
            new PageScoreNodeHelper(new Mock<ITypedPublishedContentQuery>().Object, new Mock<INodeReportService>().Object, null, new AnalyzeService());
        }
